...
def run_carla_client(args):
    ...
    # vehicles_num = [60, 60, 70, 50, 60, 60, 120, 60, 60, 60, 50, 70, 60, 50, 50]
    # vehicles_num = [35, 35, 30, 35, 35, 35, 35, 35, 35, 35, 35, 35, 40, 40, 40]
    vehicles_num = [120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 80]
    pedestrians_num = [120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 120, 80]
        ...
        for episode in list_of_episodes:
            ...
            if args.settings_filepath is None:
                ...
                settings.set(
                    ...
                    NumberOfPedestrians=pedestrians_num[episode],
